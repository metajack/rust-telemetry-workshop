...
#[tracing::instrument(name = "process total price", skip_all, fields(outcome = tracing::field::Empty))]
...
#[tracing::instrument(name = "retrieve order", skip_all, fields(outcome = tracing::field::Empty))]
